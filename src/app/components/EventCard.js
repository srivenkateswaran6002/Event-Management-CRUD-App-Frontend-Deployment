  ...
  return (
    <div className="relative text-gray-400">
      ...
      <div className="absolute top-3 right-3 flex gap-2 z-10">
        ...
        <button onClick={(e) => {e.preventDefault();e.stopPropagation(); console.log("Delete:", event.id); handleDelete(event.id)}} className="bg-red-600 hover:bg-red-700 text-white text-sm px-3 py-1 rounded">
